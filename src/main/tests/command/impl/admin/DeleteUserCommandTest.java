...
public class DeleteUserCommandTest {
    ...
    public void returnNewsPage() throws ServiceException, CommandException {
        when(userService.deleteUser(CONTENT)).thenReturn(true);
        DeleteUserCommand deleteUserCommand = new DeleteUserCommand(userService);
        Page actual = deleteUserCommand.execute(CONTENT);
