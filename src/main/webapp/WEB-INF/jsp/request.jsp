                    ...
                    <form action="controller" method="POST" enctype="multipart/form-data" class="form-signin"
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type_id" id="wanted" value="wanted" checked>
                                <label class="form-check-label" for="wanted">${requestWanted}</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type_id" id="missing" value="missing">
                                <label class="form-check-label" for="missing">${requestMissing}</label>
                            </div>
                        </div>
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="sex_id" id="male" value="male" checked>
                                <label class="form-check-label" for="male">${requestMale}</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="sex_id" id="female" value="female">
                                <label class="form-check-label" for="female">${requestFemale}</label>
                            </div>
                        </div>
                        <hr>
